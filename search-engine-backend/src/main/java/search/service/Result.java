...
public class Result {
	...
	public Map<String, Integer> getSortedOccurrencesByKeyAsc() {
		return this.occurencesOfAllKeys.entrySet().stream()
				.sorted((Map.Entry.<String, Integer>comparingByKey()))
				.collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e1, LinkedHashMap::new));
	}
	
	public Map<String, Integer> getSortedOccurrencesByKeyDesc() {
		return this.occurencesOfAllKeys.entrySet().stream()
				.sorted((Map.Entry.<String, Integer>comparingByKey().reversed()))
				.collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e1, LinkedHashMap::new));
	}
	
	public Map<String, Integer> getSortedOccurrencesByValueAsc() {
		return this.occurencesOfAllKeys.entrySet().stream()
				.sorted((Map.Entry.<String, Integer>comparingByValue()))
				.collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e1, LinkedHashMap::new));
	}
	
	public Map<String, Integer> getSortedOccurrencesByValueDesc() {
		return this.occurencesOfAllKeys.entrySet().stream()
